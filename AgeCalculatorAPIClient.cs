...
namespace APIVerve
{
    public class AgeCalculatorAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/agecalculator";
        ...
        public AgeCalculatorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public AgeCalculatorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, AgeCalculatorQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(AgeCalculatorQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(AgeCalculatorQueryOptions options)
        {
